...
{
    /// <summary>
    /// This represents the implementation of the "Shortest Job Next" processes scheduling algorithm
    /// </summary>
    public class ShortestJobNext
    {
        ...
        public ShortestJobNext(List<Process> processList, int cpu_count)
        {
            CPU_Count = cpu_count;
